...
const renderContent = {
    1: (
        <h1 className='sm:text-xl xm:leading-snug text-center neo-brutalism-blue py-4 px-8 text-white mx-5'>
            Hi, I am <span className='font-semibold'>Jean Young Park</span>🖐🏻
            <br />A software Engineer from Korea
        </h1>
    ),
    2: <InfoBox text='Work with many companies and picked up many skills along the way' link='/about' btnText='Learn more' />,
